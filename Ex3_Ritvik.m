...
rot_angle = 45;
my_rot = [cosd(-rot_angle) -sind(-rot_angle);sind(-rot_angle) cosd(-rot_angle)];
% write code to create your Homogeneous 2D Translation matrix hom_trans using d_x & d_y
hom_trans = [1 0 1;0 1 1;0 0 1];
...
hom_rot = [cosd(-rot_angle) -sind(-rot_angle) 0;sind(-rot_angle) cosd(-rot_angle) 0;0 0 1];
% write code to convert my_pts to the homogeneous system and store the result in hom_my_pts
hom_my_pts = [3 3 4 4 3;3 4 4 3 3;1 1 1 1 1];
